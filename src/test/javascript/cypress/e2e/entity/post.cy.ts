...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'ick profuse psst', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2025-05-22T20:22:56.040Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('than whether');
      cy.get(`[data-cy="title"]`).should('have.value', 'than whether');
      ...
      cy.get(`[data-cy="date"]`).type('2025-05-22T17:18');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2025-05-22T17:18');
